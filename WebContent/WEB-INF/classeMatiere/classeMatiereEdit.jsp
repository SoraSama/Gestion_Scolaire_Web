...
<head>
    ...
    <title>Edition classeMatieres</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="http://localhost:8080//GestionScolaireWeb/login/loginProcess"><i class="fa fa-home"></i> Accueil </a>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
					...
					<div class="container">
						<fieldset>
							<legend>Edition de la liste des classeMatieres</legend>
							<form:form modelAttribute="classeMatiere" action="save" method="post">
								<form:hidden path="id" />
								...
								<div class="form-group">
									<form:label path="matiere.id">Nom de la matiere</form:label>
									<form:select path="matiere.id" id="matiere.id" cssClass="form-control" cssStyle="width: 400px">
										<form:option value="${null}">Veuillez choisir une matiere</form:option>
										<c:forEach items="${matieres}" var="matiere">
											<form:option value="${matiere.id}">${matiere.nom}</form:option>
										</c:forEach>
										
									</form:select>
									<form:errors path="matiere" cssStyle="color:red"/>					
								</div>
									
								<button class="btn btn-success" type="submit">
									<span class="glyphicon glyphicon-ok"></span>
								</button>
								<button class="btn btn-warning" type="button" onclick="window.location='../classeMatiere/list';return false;">
