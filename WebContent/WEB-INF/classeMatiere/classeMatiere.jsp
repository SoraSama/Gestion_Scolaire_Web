...
<head>
    ...
    <title>Liste des classeMatieres</title>
...
<body>
 ...
 <li>
	...
	<div class="container">
		<fieldset>
			<legend>Liste des classeMatieres</legend>
			<table class="table table-striped">
				...
				<c:forEach items="${classeMatieres}" var="classeMatiere">
					<tr>
						<td>${classeMatiere.id}</td>
						<td>${classeMatiere.version}</td>
						<td>${classeMatiere.classe.nom}</td>
						<td>${classeMatiere.matiere.nom}</td>

						
						<td><a href="edit?id=${classeMatiere.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="delete?id=${classeMatiere.id}" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
