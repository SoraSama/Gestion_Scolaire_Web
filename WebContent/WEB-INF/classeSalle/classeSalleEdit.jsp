...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="../classeclasseSalle/list"><b><spring:message code="MenuNav.ville" /></b></a></li>
...
<div style="height: 100px;"></div>
	<div class="container">
		<fieldset>
			<legend>Edition de la liste des classeSalles</legend>
			<form:form modelAttribute="classeSalle" action="save" method="post">
				<form:hidden path="id" />
				...
				<div class="form-group">
					<form:label path="salle.id">Nom de la salle</form:label>
					<form:select path="salle.id" id="salle.id" cssClass="form-control" cssStyle="width: 400px">
						<form:option value="${null}">Veuillez choisir une salle</form:option>
						<c:forEach items="${salles}" var="salle">
							<form:option value="${salle.id}">${salle.nom}</form:option>
						</c:forEach>
						
					</form:select>
					<form:errors path="salle" cssStyle="color:red"/>					
				</div>
					
				<button class="btn btn-success" type="submit">
					<span class="glyphicon glyphicon-ok"></span>
				</button>
				<button class="btn btn-warning" type="button" onclick="window.location='../classeSalle/list';return false;">
