			...
			<table class="table table-striped" >
				...
				<c:forEach items="${matieres}" var="matiere">
					<tr>
						...
						<td><a href="edit?id=${matiere.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="delete?id=${matiere.id}" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
