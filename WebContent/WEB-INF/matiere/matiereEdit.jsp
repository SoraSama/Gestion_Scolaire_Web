...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="../matiere/list"><b><spring:message code="MenuNav.ville" /></b></a></li>
...
<div style="height: 100px;"></div>
	<div class="container">
		<fieldset>
			<legend>Edition de la liste des matieres</legend>
			<form:form modelAttribute="matiere" action="save" method="post">
				<form:hidden path="id" />
				...
				<div class="form-group">
					...
					<form:input path="couleur" type="text" cssClass="form-control" cssStyle="width: 400px"/>
				</div>
					
				<button class="btn btn-success" type="submit">
					<span class="glyphicon glyphicon-ok"></span>
				</button>
				<button class="btn btn-warning" type="button" onclick="window.location='../matiere/list';return false;">
