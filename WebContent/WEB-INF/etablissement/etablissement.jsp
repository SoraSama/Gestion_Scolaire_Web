							...
							<table class="table table-striped">
								...
								<c:forEach items="${etablissements}" var="etablissement">
									<tr>
										...
										<td>${etablissement.version}</td>
										<td>${etablissement.nom}</td>
										<td>${etablissement.type}</td>
										<td>${etablissement.logo}</td>
										<td>${etablissement.adresse.rue}</td>
										<td>${etablissement.adresse.ville}</td>
										<td>${etablissement.adresse.codePostal}</td>
										<td>${etablissement.adresse.pays}</td>
				
										
										<td><a href="edit?id=${etablissement.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
										<td><a href="delete?id=${etablissement.id}" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a></td>
									</tr>
								</c:forEach>
