...
<head>
    ...
    <title>Edition professeur</title>
		...
		<fieldset>
			...
			<form:form modelAttribute="professeur" action="save" method="post">
				...
				<div class="form-group">
					...
					<form:input pattern="\d{1,2}/\d{1,2}/\d{4}" placeholder ="jj/mm/aaaa" path="dateDeNaissance" type="date" cssClass="form-control" cssStyle="width: 400px"/>
