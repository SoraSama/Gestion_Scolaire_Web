		...
		<fieldset>
			...
			<table class="table table-striped">
				...
				<c:forEach items="${professeurs}" var="professeur">
					<tr>
						<td>${professeur.id}</td>
						<td>${professeur.version}</td>
						<td>${professeur.nom}</td>
						<td>${professeur.prenom}</td>
						<td>${professeur.dateDeNaissance}</td>
						<td>${professeur.etablissement.nom}</td>

						
						<td><a href="edit?id=${professeur.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="delete?id=${professeur.id}" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
