...
<head>
    ...
    <title>Liste des classeProfesseur</title>
...
<body>
 ...
 <li>
	...
	<div class="container">
		<fieldset>
			<legend>Liste des classeProfesseurs</legend>
			<table class="table table-striped">
				<tr>
					<th>Id</th>
					<th>Version</th>
					<th>Nom de la classe</th>
					<th>Nom de la professeur</th>
					<th></th>
					<th></th>
				</tr>

				<c:forEach items="${classeProfesseurs}" var="classeProfesseur">
					<tr>
						<td>${classeProfesseur.id}</td>
						<td>${classeProfesseur.version}</td>
						<td>${classeProfesseur.classe.nom}</td>
						<td>${classeProfesseur.professeur.nom}</td>

						
						<td><a href="edit?id=${classeProfesseur.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="delete?id=${classeProfesseur.id}" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
